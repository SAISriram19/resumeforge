    ...
    <div className="min-h-screen bg-[#f5f1e8] flex">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-8 bg-[#e8dcc4]/30">
        <div className="w-full max-w-md flex-1 flex flex-col justify-center">
          ...
          {/* Login heading */}
          <div className="mb-8">
            <h2 className="text-3xl font-semibold text-[#2d2a26] mb-2">Log in to your account</h2>
            <div className="flex items-center gap-1 text-sm">
              <span className="text-[#6b5d4f]">Don't have an account?</span>
              <Link to="/signup" className="text-[#2d2a26] underline hover:no-underline">
                Sign up instead
              </Link>
            </div>
          </div>
